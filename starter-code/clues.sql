...
select code character, name, population from country where region like 'Southern Europe' order by population desc;
Answer: ITA|Italy, population: 57680000

-- Clue #2: Now that we're here, we have insight that Carmen was seen attending language classes in
-- this country's officially recognized language. Check our databases and find out what language is
-- spoken in this country, so we can call in a translator to work with you.
select language, isofficial from countrylanguage where countrycode like 'ITA';
Answer: Italian
Italian|t
Sardinian|f
Friuli|f
...
select * from countrylanguage where language like 'Italian' and isofficial like 't';
...
Answer = 265|Serra|BRA|Esp�rito Santo|302666
